/**
 * RegisterPage.jsx — Premium registration page with split layout
 */
import React, { useState, useEffect } from 'react';
import { Link, useNavigate } from 'react-router-dom';
import { motion } from 'framer-motion';
import { Shield, User, Lock, UserPlus, AlertCircle, CheckCircle, ArrowRight } from 'lucide-react';
    ...
    <div className="auth-page">
      ...
      <div className="auth-layout content-layer">
        ...
        >
          ...
          <h1 className="auth-hero-title">
            Join the<br />
            <span className="text-gradient-red">Emergency</span><br />
            Network.
          </h1>
          <p className="auth-hero-desc">
            Register your account to gain secure access to the SOS Alert System and emergency response tools.
          </p>
          <div className="auth-features">
            {['Instant secure registration', 'End-to-end encrypted alerts', 'Real-time dashboard access'].map((f, i) => (
              <motion.div
                key={f}
        ...
        >
          ...
          <form onSubmit={handleSubmit} noValidate className="auth-form">
            ...
            <div className="input-group">
              <label className="input-label" htmlFor="r-username">Username</label>
            ...
            {/* Password */}
            <div className="input-group">
              <label className="input-label" htmlFor="r-password">Password</label>
              <div className="input-wrap">
      ...
      <style>{`
        ...
        .auth-feature-dot {
          ...
          background: var(--primary); box-shadow: 0 0 8px rgba(229,62,62,0.5);
          flex-shrink: 0;
        }
        .auth-card {
          width: 100%; max-width: 440px; padding: var(--space-10); flex-shrink: 0;
        ...
        .auth-card-sub { font-size: var(--text-sm); color: var(--text-muted); line-height: 1.6; }
        .auth-form { display: flex; flex-direction: column; gap: var(--space-5); }
        .auth-btn {
          width: 100%; padding: var(--space-4); font-size: var(--text-base);
          margin-top: var(--space-3); border-radius: var(--radius-xl); letter-spacing: 0.01em;
        }
        .auth-footer {
          display: flex; align-items: center; justify-content: center;
          gap: var(--space-2); margin-top: var(--space-8); padding-top: var(--space-6);
          border-top: 1px solid var(--border);
        }
        .auth-footer-text { font-size: var(--text-sm); color: var(--text-muted); }
        .auth-footer-link { font-size: var(--text-sm); font-weight: 600; color: var(--primary); transition: color 0.15s ease; }
        .auth-footer-link:hover { color: var(--primary-light); }

        @media (max-width: 900px) {
          .auth-layout { flex-direction: column; gap: var(--space-10); padding: var(--space-10) var(--space-6); justify-content: flex-start; align-items: center; min-height: 100vh; }
          .auth-left { max-width: 100%; gap: var(--space-5); align-items: center; text-align: center; }
